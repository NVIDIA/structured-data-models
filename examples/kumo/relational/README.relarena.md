...
| System (`sdm-kumo-system`) | [rel_arena_system.py](rel_arena_system.py) | The system evaluates its candidate policy on full validation, then refits the winner on TRAIN+VAL and returns masked TEST predictions. |
