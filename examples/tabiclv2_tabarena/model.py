...
class SDMTabICLv2Model(AbstractModel):
    ...
    The class deliberately lives in an importable example module. This keeps
    the SDM package free of TabArena dependencies while allowing AutoGluon to
    import it when it schedules bagged folds through Ray.
    """
