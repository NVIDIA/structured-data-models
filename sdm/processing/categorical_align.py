...
class CategoricalAlign(Processor):
    ...
    Fitting stores the category values that are actually observed in each
    categorical column. Transforming remaps input codes by category value to
    those fitted vocabularies. Missing values and categories not observed
