...
PROCESSOR_CASES = (
    ...
    ProcessorCase(sp.CrossFeatures(2)),
    ProcessorCase(sp.TruncatedSVD(2), _make_reduction_table),
    ...
    ProcessorCase(sp.OneHot()),
    ProcessorCase(sp.AddCalendarFields(["year", "month"])),
