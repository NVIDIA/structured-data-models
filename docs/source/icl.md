...
The full relational sampling and prediction flow is shown in [`benchmark/relational/relbench/main.py`](https://github.com/NVIDIA/structured-data-models/blob/main/benchmark/relational/relbench/main.py).
